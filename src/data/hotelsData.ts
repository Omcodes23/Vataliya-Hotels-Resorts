...
export const HOTELS_DATA: Record<string, HotelData> = {
  'manaw-valley-resort': {
    ...
    tagline: '4-Star Luxury Mountain Resort in Shimla · Operated by Vataliya',
    starRating: 4,
    ...
    about: {
      ...
      keyStats: [
        { label: 'Category', value: '4-Star Luxury Resort' },
...
export const DESTINATIONS_DATA: DestinationLocation[] = [
  {
    ...
    description:
      'Perched amidst rolling pine hills and cedar-draped ridges, Shimla offers colonial architecture, crisp mountain air, and panoramic Himalayan vistas. Home to our 4-star sanctuary, Manaw Valley Resort.',
    heroImage: 'https://manawvalleyresort.com/gallery/1.jpg',
    elevation: '2,276m',
